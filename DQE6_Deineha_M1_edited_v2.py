...
#  The list for exception handling
random_list =  [23, 29,  31,  65,  93, 103, 105, 109,  115, 119,  139, 163]
...
# Even_AVG=(even_sum / even_list ) if even_list != 0 else 0

# calculate the average= (sum / count) and print the result for even numbers
# print ('Even AVG:', (even_sum / even_list ) if even_list != 0 else '0 - Even numbers are absent')
try:
    print('Even AVG:', (even_sum / even_list))

except ZeroDivisionError:

    print("Cannot divide by zero, Even numbers are absent")
...
for o in random_list:
        ...
        if  o % 2 !=0:
           ...
           # calculate the count
           odd_list  +=1
# Odd_AVG = (odd_sum / odd_list) if even_list != 0 else 0
#  calculate the average= (sum / count) and print the result for odd numbers
# print ('Odd AVG:', (odd_sum / odd_list) if odd_list != 0 else '0-Odd numbers are absent')
...
try:
    ...
    print("Cannot divide by zero, Odd numbers are absent")